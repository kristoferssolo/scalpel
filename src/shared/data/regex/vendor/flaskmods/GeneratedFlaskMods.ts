    ...
    mods: [
      {
        ...
        name: 'Enduring',
        value:
          'Effect is not removed when Unreserved Mana is Filled Effect does not Queue 66% reduced Amount Recovered',
        regex: 'endu',
      },
    ],
  },
    ...
    mods: [
      {
        ...
        name: 'of the Seal',
        value:
          '(51-55)% chance to Avoid being Chilled during Effect (51-55)% chance to Avoid being Frozen during Effect',
        regex: 'e seal',
      },
      {
        level: 61,
        name: 'of the Beluga',
        value:
          '(46-50)% chance to Avoid being Chilled during Effect (46-50)% chance to Avoid being Frozen during Effect',
        regex: 'elu',
      },
      {
        level: 42,
        name: 'of the Narwhal',
        value:
          '(41-45)% chance to Avoid being Chilled during Effect (41-45)% chance to Avoid being Frozen during Effect',
        regex: 'rw',
      },
      {
        level: 23,
        ...
        value:
          '(36-40)% chance to Avoid being Chilled during Effect (36-40)% chance to Avoid being Frozen during Effect',
        regex: 'lio',
      },
      {
        level: 4,
        name: 'of the Orca',
        value:
          '(31-35)% chance to Avoid being Chilled during Effect (31-35)% chance to Avoid being Frozen during Effect',
        regex: 'orc',
      },
    ],
  },
    ...
    mods: [
      {
        ...
        name: 'of the Bear',
        value:
          '(65-60)% reduced Effect of Chill on you during Effect (65-60)% reduced Freeze Duration on you during Effect',
        regex: 'bea',
      },
      {
        level: 61,
        name: 'of the Sable',
        value:
          '(59-52)% reduced Effect of Chill on you during Effect (59-52)% reduced Freeze Duration on you during Effect',
        regex: 'sab',
      },
      {
        level: 42,
        name: 'of the Fox',
        value:
          '(52-48)% reduced Effect of Chill on you during Effect (52-48)% reduced Freeze Duration on you during Effect',
        regex: 'fox',
      },
      {
        level: 23,
        name: 'of the Cat',
        value:
          '(47-42)% reduced Effect of Chill on you during Effect (47-42)% reduced Freeze Duration on you during Effect',
        regex: 'of the Cat$',
      },
      {
        level: 4,
        name: 'of the Rabbit',
        value:
          '(41-36)% reduced Effect of Chill on you during Effect (41-36)% reduced Freeze Duration on you during Effect',
        regex: 'rab',
      },
    ],
  },
    ...
    mods: [
      {
        ...
        name: 'of Allaying',
        value:
          'Grants Immunity to Bleeding for (12-14) seconds if used while Bleeding Grants Immunity to Corrupted Blood for (12-14) seconds if used while affected by Corrupted Blood',
        regex: 'lay',
      },
      {
        level: 80,
        name: 'of Assuaging',
        value:
          'Grants Immunity to Bleeding for (15-17) seconds if used while Bleeding Grants Immunity to Corrupted Blood for (15-17) seconds if used while affected by Corrupted Blood',
        regex: 'sua',
      },
      {
        level: 8,
        name: 'of Sealing',
        value:
          'Grants Immunity to Bleeding for (6-8) seconds if used while Bleeding Grants Immunity to Corrupted Blood for (6-8) seconds if used while affected by Corrupted Blood',
        regex: 'eali',
      },
      {
        level: 32,
        name: 'of Alleviation',
        value:
          'Grants Immunity to Bleeding for (9-11) seconds if used while Bleeding Grants Immunity to Corrupted Blood for (9-11) seconds if used while affected by Corrupted Blood',
        regex: 'evi',
      },
    ],
  },
    ...
    mods: [
      {
        ...
        name: 'of Entropy',
        value:
          'Grants Immunity to Chill for (12-14) seconds if used while Chilled Grants Immunity to Freeze for (12-14) seconds if used while Frozen',
        regex: 'tro',
      },
      {
        level: 76,
        name: 'of Thawing',
        value:
          'Grants Immunity to Chill for (15-17) seconds if used while Chilled Grants Immunity to Freeze for (15-17) seconds if used while Frozen',
        regex: 'aw',
      },
      {
        level: 4,
        name: 'of Convection',
        value:
          'Grants Immunity to Chill for (6-8) seconds if used while Chilled Grants Immunity to Freeze for (6-8) seconds if used while Frozen',
        regex: 'onv',
      },
      {
        level: 28,
        ...
        value:
          'Grants Immunity to Chill for (9-11) seconds if used while Chilled Grants Immunity to Freeze for (9-11) seconds if used while Frozen',
        regex: 'cs',
      },
    ],
  },
    ...
    mods: [
      {
        ...
        name: 'of Freedom',
        value:
          'Grants Immunity to Hinder for (12-14) seconds if used while Hindered Grants Immunity to Maim for (12-14) seconds if used while Maimed',
        regex: 'edo',
      },
      {
        level: 82,
        name: 'of Liberation',
        value:
          'Grants Immunity to Hinder for (15-17) seconds if used while Hindered Grants Immunity to Maim for (15-17) seconds if used while Maimed',
        regex: 'lib',
      },
      {
        level: 16,
        name: 'of Movement',
        value:
          'Grants Immunity to Hinder for (6-8) seconds if used while Hindered Grants Immunity to Maim for (6-8) seconds if used while Maimed',
        regex: 'f mov',
      },
      {
        level: 38,
        name: 'of Motion',
        value:
          'Grants Immunity to Hinder for (9-11) seconds if used while Hindered Grants Immunity to Maim for (9-11) seconds if used while Maimed',
        regex: 'mot',
      },
    ],
  },
    ...
    mods: [
      {
        ...
        value:
          "Recover an additional (35-40)% of Flask's Life Recovery Amount over 10 seconds if used while not on Full Life",
        regex: 'enn',
      },
      {
        level: 67,
        name: 'of Incessance',
        value:
          "Recover an additional (29-34)% of Flask's Life Recovery Amount over 10 seconds if used while not on Full Life",
        regex: 'ssa',
      },
      {
        level: 53,
        name: 'of Bounty',
        value:
          "Recover an additional (23-28)% of Flask's Life Recovery Amount over 10 seconds if used while not on Full Life",
        regex: 'unty',
      },
      {
        level: 39,
        name: 'of Plenty',
        value:
          "Recover an additional (17-22)% of Flask's Life Recovery Amount over 10 seconds if used while not on Full Life",
        regex: 'enty',
      },
      {
        level: 25,
        name: 'of Abundance',
        value:
          "Recover an additional (11-16)% of Flask's Life Recovery Amount over 10 seconds if used while not on Full Life",
        regex: 'danc',
      },
    ],
  },
