export const CHANGELOG: { version: string; notes: string[] }[] = [
  {
    ...
    notes: [
      ...
      'Added price-check support for runeforged and mastered bases.',
      ...
      'Fixed The Taming ring to PoE2 with its trade icon.',
      'Fixed From Nothing to the PoE2 build-enabling premium mods checked by default in the price checker.',
