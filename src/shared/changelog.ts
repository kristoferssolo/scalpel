export const CHANGELOG: { version: string; notes: string[] }[] = [
  {
    ...
    notes: [
      ...
      'Added feature to add "macro" to any custom tag in regex and then hotkey it in settings',
      'Added trade setting to default searches to base',
      'Added "base" to unique and corrupted stretching the definition of base but it works nicely',
      'Added paradigm of shown but off rows on uniques and base mode in settings',
